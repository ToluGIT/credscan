...
from credscan.enhanced.pattern_library import (
...
from credscan.enhanced.pattern_structure import (
    CredentialPattern,
    PatternCategory,
    PatternLibrary,
)
...
class TestPatternStructure(unittest.TestCase):
    ...
    def test_pattern_category(self):
        ...
        category = PatternCategory(name="test_category", description="Test category")
    ...
    def test_pattern_library(self):
        ...
        category1.add_pattern(
            CredentialPattern(name="Pattern 1", pattern=r"cat1-[0-9]+")
        )

        category2 = PatternCategory(name="category2", description="Category 2")
        category2.add_pattern(
            CredentialPattern(name="Pattern 2", pattern=r"cat2-[0-9]+")
        )
...
class TestPatternLibrary(unittest.TestCase):
    ...
    def test_save_and_load_patterns(self):
        ...
        category.add_pattern(
            CredentialPattern(name="Test Pattern", pattern=r"test-[0-9]+")
        )
...
class TestRuleEngineIntegration(unittest.TestCase):
    ...
    def test_enhanced_rule(self):
        ...
        category = PatternCategory(name="test", description="Test Category")
        category.add_pattern(
            CredentialPattern(name="Test Pattern", pattern=r"secret-[0-9]+")
        )
        library.add_category(category)
        ...
        # Mock parsed content
        parsed_content = {
            "items": [{"key": "api_key", "value": "secret-12345", "line": 10}]
        }
    ...
    def test_enhanced_rule_loader(self):
        ...
        category.add_pattern(
            CredentialPattern(name="AWS Key", pattern=r"AKIA[0-9A-Z]{16}")
        )
        library.add_category(category)
...
class TestConfigIntegration(unittest.TestCase):
    ...
    def test_config_save_load(self):
        ...
        try:
            ...
            self.assertEqual(
                loaded_config.enabled_categories, config.enabled_categories
            )
