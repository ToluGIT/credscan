...
_PREVENTION = (
    "Add CredScan as a pre-commit hook and a CI gate so the secret "
...
_CATEGORY_ALIASES = {
    ...
    "azure": "generic",
    "github": "github",
    "github___gitlab___bitbucket": "github",
    "slack": "slack",
    "messaging___chat": "slack",
    "stripe": "stripe",
    "payments___banking": "stripe",
    "private_keys": "private_keys",
    "ssh___ssl___certs": "private_keys",
...
def _key_for_finding(finding: Dict[str, Any]) -> str:
    haystack = " ".join(
        str(finding.get(k, ""))
        for k in ("pattern_category", "category", "rule_name", "type")
    ).lower()
